...
> **Security Note:** Environment variables containing credentials should be set securely and never committed to version control. Use your hosting provider's secrets management or a `.env` file excluded from source control.
