...
Addons can define custom permission strings that appear alongside built-in permissions in the admin role editor. See [Addon Development → Custom Admin Permissions](addon-development#custom-admin-permissions) for details.
