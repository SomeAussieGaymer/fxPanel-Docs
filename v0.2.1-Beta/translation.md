...
> **Quick Testing:** Edit the `locale.json` file and then click "Save Global Settings" in the settings page. Changes take effect immediately without restarting fxPanel or the server.
